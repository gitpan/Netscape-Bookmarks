# This Makefile is for the Netscape::Bookmarks extension to perl.
#
...
#     MAN3PODS => { lib/Link.pm=>q[$(INST_MAN3DIR)/Netscape::Bookmarks::Link.3], lib/Separator.pm=>q[$(INST_MAN3DIR)/Netscape::Bookmarks::Separator.3], lib/Alias.pm=>q[$(INST_MAN3DIR)/Netscape::Bookmarks::Alias.3], lib/Bookmarks.pm=>q[$(INST_MAN3DIR)/Netscape::Bookmarks.3], lib/Category.pm=>q[$(INST_MAN3DIR)/Netscape::Bookmarks::Category.3] }
#     NAME => q[Netscape::Bookmarks]
#     PM => { lib/Link.pm=>q[$(INST_LIBDIR)/Bookmarks/Link.pm], lib/Separator.pm=>q[$(INST_LIBDIR)/Bookmarks/Separator.pm], lib/Alias.pm=>q[$(INST_LIBDIR)/Bookmarks/Alias.pm], lib/Bookmarks.pm=>q[$(INST_LIBDIR)/Bookmarks.pm], lib/Category.pm=>q[$(INST_LIBDIR)/Bookmarks/Category.pm] }
#     PREREQ_PM => { HTML::Entities=>q[0], HTML::Parser=>q[0], URI::URL=>q[0] }
#     VERSION_FROM => q[lib/Bookmarks.pm]
#     clean => { FILES=>q[Netscape-* Bookmarks_tmp.html bookmark_files/Bookmarks_tmp.html] }
...
FULLEXT = Netscape/Bookmarks
BASEEXT = Bookmarks
PARENT_NAME = Netscape
DLBASE = $(BASEEXT)
...
INST_LIBDIR      = $(INST_LIB)/Netscape
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Netscape
...
TO_INST_PM = lib/Alias.pm \
	lib/Bookmarks.pm \
	lib/Category.pm \
	lib/Link.pm \
	lib/Separator.pm

PM_TO_BLIB = lib/Link.pm \
	$(INST_LIBDIR)/Bookmarks/Link.pm \
	lib/Separator.pm \
	$(INST_LIBDIR)/Bookmarks/Separator.pm \
	lib/Alias.pm \
	$(INST_LIBDIR)/Bookmarks/Alias.pm \
	lib/Bookmarks.pm \
	$(INST_LIBDIR)/Bookmarks.pm \
	lib/Category.pm \
	$(INST_LIBDIR)/Bookmarks/Category.pm
...
clean :: clean_subdirs
	-$(RM_RF) Netscape-* Bookmarks_tmp.html bookmark_files/Bookmarks_tmp.html ./blib $(MAKE_APERL_FILE) $(INST_ARCHAUTODIR)/extralibs.all $(INST_ARCHAUTODIR)/extralibs.ld perlmain.c tmon.out mon.out so_locations pm_to_blib *$(OBJ_EXT) *$(LIB_EXT) perl.exe perl perl$(EXE_EXT) $(BOOTSTRAP) $(BASEEXT).bso $(BASEEXT).def lib$(BASEEXT).def $(BASEEXT).exp $(BASEEXT).x core core.*perl.*.? *perl.core core.[0-9] core.[0-9][0-9] core.[0-9][0-9][0-9] core.[0-9][0-9][0-9][0-9] core.[0-9][0-9][0-9][0-9][0-9]
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(INST_LIBDIR)/Bookmarks/Category.pm $(INST_LIBDIR)/Bookmarks/Alias.pm $(INST_LIBDIR)/Bookmarks/Link.pm $(INST_LIBDIR)/Bookmarks/Separator.pm $(INST_LIBDIR)/Bookmarks.pm $(MAKEFILE_OLD)
	$(RM_F) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) '    HTML::Parser:                  0' >> META.yml
